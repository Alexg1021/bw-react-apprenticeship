...
if (bodyTag.className == 'show-reminder') {
  setTimeout(function () {
    alert('Did you add, commit, and push your code from last class?');
  }, 2000);
}
if (bodyTag.className == 'welcome-msg') {
  setTimeout(function () {
    alert(
      "Welcome to Geekwise Academy's Websites for Beginners course. Here are some things you should know: Door code: 25829# WiFi: 'Bitwise' password: BUTTONBOX (all caps) Slack Channel: #websitesforbeginners"
    );
  }, 2000);
}
